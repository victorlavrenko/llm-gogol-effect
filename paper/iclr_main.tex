...
\usepackage{url}
\usepackage{hyperref}
\hypersetup{hidelinks,pdfauthor={Anonymous},pdftitle={The Gogol Effect in LLMs: Post-Completion Self-Devaluation}}

\title{The Gogol Effect in LLMs: Post-Completion Self-Devaluation}
